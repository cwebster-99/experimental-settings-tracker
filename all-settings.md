...
| **chat.todoListTool** | | |
| `chat.todoListTool.descriptionField` | `true` | experimental |
| `chat.todoListTool.writeOnly` | `false` | experimental |
| **editor.experimental** | | |
...
| `github.copilot.chat.anthropic.useMessagesApi` | `false` | experimental, onExp |
| `github.copilot.chat.azureAuthType` | `"entraId"` | experimental |
| `github.copilot.chat.azureModels` | `{}` | experimental |
| `github.copilot.chat.byok.ollamaEndpoint` | `"http://localhost:11434"` | preview |
...
| `github.copilot.chat.cli.autoCommit.enabled` | `false` | advanced, experimental |
| `github.copilot.chat.cli.customAgents.enabled` | `false` | advanced, experimental |
...
| `github.copilot.chat.customOAIModels` | `{}` | experimental |
